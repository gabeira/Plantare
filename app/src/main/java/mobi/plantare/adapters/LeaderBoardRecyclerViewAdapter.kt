 ...
 */
class LeaderBoardRecyclerViewAdapter(private val context: Context, private val mValues: ArrayList<PlantareUser>) : RecyclerView.Adapter<LeaderBoardRecyclerViewAdapter.ViewHolder>() {
